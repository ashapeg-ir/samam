...
LANGUAGES = [("en-us", _("English")), ("de", _("German")), ("fa-IR", _("Persian"))]
...
MIGRATION_MODULES = {"sites": "samam.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "modules.common.contexts.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""zarinpy""", "zarinpy@gmail.com")]
...
GRAPHENE = {
    "SCHEMA": "modules.palace.graph_test.schema"
}
