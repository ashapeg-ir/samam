...
class AdminSite(BaseAdmin):
    ...
    site_title = gettext_lazy("Samam admin site")

    # Text to put in each page's <h1>.
    site_header = gettext_lazy("Samam admin panel")

    # Text to put at the top of the admin index page.
    index_title = gettext_lazy("Samam administration")
...
class AdminConfig(adminApps.AdminConfig):
    default_site = 'modules.admin.apps.AdminSite'
    label = 'admin'
